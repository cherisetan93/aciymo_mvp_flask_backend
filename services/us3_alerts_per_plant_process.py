...
alert_management_us3_services = Blueprint('alert_management_us3_apis', __name__)

# Alert Management Routes

# API Service that provides Alert Listings Per Process (User Story 3)
@alert_management_us3_services.route('/api/v0/alerts-per-plant-process/<int:process_number>', methods=['GET'])
